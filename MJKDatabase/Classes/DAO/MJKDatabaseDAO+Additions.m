...
#import "MJKDatabase+Additions.h"
#import "MJKDatabaseDefine.h"

@implementation MJKDatabaseDAO (Additions)
...
- (NSArray<NSDictionary *> *)getTableInfoForTable:(NSString *)tableName {
    ...
    NSArray <NSDictionary *> *tableInfo = [[MJKDatabaseDAO sharedInstance] executeQuery:sql];
...
- (NSArray<NSString *> *)getAllTableName {
    ...
    NSArray<NSDictionary *> *sqliteMasterInfos = [[MJKDatabaseDAO sharedInstance] executeQuery:sql];
...
- (NSDictionary<NSString*, NSDictionary*> *)getIndexesFromSqliteMasterForTable:(NSString *)tableName {
    ...
    NSArray<NSDictionary *> *indexInfos = [[MJKDatabaseDAO sharedInstance] executeQuery:sql];
